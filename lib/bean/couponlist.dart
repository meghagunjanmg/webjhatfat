...
class CouponList {
  ...
  factory CouponList.fromJson(dynamic json){
    return CouponList(json['coupon_id'], json['coupon_name'], json['coupon_code'], json['coupon_description'], json['start_date'], json['end_date'], json['amount'], json['type'], json['uses_restriction'], json['vendor_id'],json['cart_value'],json['status'],json['vendor_name']);
  }
