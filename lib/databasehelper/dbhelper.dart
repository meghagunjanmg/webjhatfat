...
class DatabaseHelper {
  static final databaseName = "jhatfatsss.db";
  ...
  Future<List<Map<String, dynamic>>> getPharmaProduct() async {
    ...
    return await db.rawQuery(
        'SELECT $pharmatable.$varientId, $pharmatable.$addQnty, $pharmatable.$quantitiy, $pharmatable.$unit, $pharmatable.$price, $pharmatable.$productName , $pharmatable.$storeName FROM $pharmatable');
  }
