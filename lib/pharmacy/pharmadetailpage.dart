...
import 'package:jhatfat/pharmacy/pharmabean/pharmahomecategory.dart';
...
class PharmaItemPage extends StatefulWidget {
  ...
  @override
  _ItemsPharmaPageState createState() => _ItemsPharmaPageState(vendorName,vendor_id,deliveryRange,distance);
}
...
class _ItemsPharmaPageState extends State<PharmaItemPage>
  ...
  late dynamic vendor_id="";
  late dynamic deliveryRange="";
  late dynamic distance="";

  _ItemsPharmaPageState(this.vendorName, this.vendor_id, this.deliveryRange, this.distance);
  ...
  void hitPharmacyItem() async {
    ...
    http.post(myUri, body: {'vendor_id': '${widget.vendor_id}'}).then((response) {
