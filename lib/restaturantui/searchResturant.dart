...
import 'package:jhatfat/bean/resturantbean/searchcategory.dart';
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    if ((nearStores[index].online_status ==
                                      ...
                                      Toast.show(
                                          'Restaurant are closed now!', duration: Toast.lengthShort, gravity:  Toast.bottom);
                                    }
                                  },
                                  child: Material(
                                      elevation: 2,
...
//          List<SubCategoryList> _tags3 = tagObjsJsonSub.map((tagJson) => SubCategoryList.fromJson(tagJson)).toList();
          ...
          Toast.show('Store not found',  duration: Toast.lengthShort, gravity:  Toast.bottom);
        }
      }
    }).catchError((e) {
      Toast.show('Store not found',  duration: Toast.lengthShort, gravity:  Toast.bottom);
                          ...
                          onPressed: () {
                            setState(() {
                              if (data[index].stock > data[index].add_qnty) {
                                ...
                                Toast.show("No more stock available!", duration: Toast.lengthShort, gravity:  Toast.bottom);
                              }
                            });
                          },
                          child: Text(
                              ...
                              onTap: () {
                                setState(() {
                                  if (data[index].stock >
                                    ...
                                    Toast.show(
                                        "No more stock available!", duration: Toast.lengthShort, gravity:  Toast.bottom);
                                  }
                                });
                              },
                              child: Icon(
